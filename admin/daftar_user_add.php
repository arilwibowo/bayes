                ...
                <div class="col-lg-12">
					...
					<div class="col-lg-10">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" name="nama_perti" placeholder="Nama Ibu" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">NAMA BAPAK</label>
							<div class="col-lg-8">
								<input type="text" name="nama_jurusan" placeholder="Nama Bapak" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-4">ALAMAT LENGKAP</label>
							<div class="col-lg-8">
								<input type="text" name="tahun_masuk" placeholder="Alamat" class="form-control" />
							</div>
						</div>
						<div class="form-group">
