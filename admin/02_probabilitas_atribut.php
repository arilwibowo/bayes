...
<tr>
	<td width="50%">
        RUMUS STUNTING : 
		<ol>
			<li>Jumlah JAWABAN YA pada Atribut Reguler yang STUNTING / Jumlah kelulusan STUNTING pada Atribut Class (Contoh : 22/31 = 0.71 atau 71%) </li>
			<li>Jumlah JAWABAN TIDAK pada Atribut Reguler yang lulus STUNTING / Jumlah kelulusan STUNTING pada Atribut Class (Contoh : 9/31 = 0.29 atau 29%)</li>
			<li>Jumlah JAWABAN YA dan TIDAK pada Atribut Reguler yang STUNTING harus sama dengan 100% (Contoh : 71% + 29% = 100%</li>
		</ol>
        RUMUS NORMAL : 
		<ol>
			<li>Jumlah JAWABAN YA pada Atribut Reguler yang NORMAL / Jumlah NORMAL pada Atribut Class (Contoh : 6/19 = 0.32 atau 32%) </li>
			<li>Jumlah JAWABAN TIDAK pada Atribut Reguler yang NORMAL / Jumlah NORMAL pada Atribut Class (Contoh : 13/19 = 0.68 atau 68%)</li>
			<li>Jumlah JAWABAN YA dan TIDAK pada Atribut Reguler yang NORMAL harus sama dengan 100% (Contoh : 32% + 68% = 100%</li>
		</ol>
	</td>
</tr>
</table>
...
<tr>
	...
	<td style="text-align: center;">STUNTING</td>
...
<tr>
	<td width="50%">
		...
		<ol>
			<li>Setiap Nilai Ya dan Tidak pada Atribut Class STUNTING dikalikan pada masing-masing Nilai Atribut Regulernya<br>(Contoh : 0.71*0.55*0.39*0.45*0.61*0.42*0.55*0.55*0.39*0.35*0.61*0.68*0.48*0.48).</li>
			<li>Setiap Nilai Ya dan Tidak pada Atribut Class NORMAL dikalikan pada masing-masing Nilai Atribut Regulernya<br>(Contoh : 0.32*0.79*0.26*0.53*0.16*0.58*0.37*0.53*0.21*0.63*0.11*0.11*0.63*0.21).</li>
			<li>Jika Total Nilai Perhitungan Atribut STUNTING lebih tinggi daripada Nilai Perhitungan Atribut NORMAL, maka Prediksi nya adalah STUNTING.</li>
			<li>Jika Total Nilai Perhitungan Atribut STUNTING lebih rendah daripada Nilai Perhitungan Atribut NORMAL, maka Prediksi nya adalah NORMAL.</li>
		</ol>
	</td>
</tr>
</table>
