...
<title>Algoritma Naive Bayes Untuk Mendiagnosa Stunting pada Balita </title>
      ...
      <div class="hero_section">
        <div class="row">
          ...
          <div class="top_left_cont col-lg-4 col-sm-5">
				...
				<tbody>
					<?php
						...
						while ($record = mysqli_fetch_array($query)){
							...
							echo "</tr>";
							echo "<tr>";
							echo "<td>Keterangan Diagnosa</td>";
            ...
            <div class="top_left_cont animated">
			<h3>STUNTING : <?php  echo round((float)($hitung_tepat/($hitung_tepat+$hitung_terlambat)) * 100 ) . '%'; ?> | 
			NORMAL : <?php  echo round((float)($hitung_terlambat/($hitung_tepat+$hitung_terlambat)) * 100 ) . '%'; ?> | 
			PREDIKSI DIAGNOSA: <?php  if($hitung_tepat>$hitung_terlambat){ $waktululus = "STUNTING"; }else{ $waktululus = "NORMAL"; } echo $waktululus;?>
